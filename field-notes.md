...
Altair is the third corner of the Summer Triangle and one of our closest bright-star neighbors — a crisp white star that noticeably twinkles when it's low. It spins ferociously fast — once around in well under a day, roughly nine hours against the Sun's leisurely month — so fast that it bulges out at the equator into a flattened, egg-like shape. It was one of the very first stars beyond the Sun to have its actual surface imaged — and sure enough, it came out squashed.
...
If the Whirlpool shows a galaxy from straight above, the Sombrero shows one almost exactly edge-on — and the angle is everything. We see its disk tilted just six degrees from perfectly side-on, so a dark lane of dust rings the galaxy like the brim of a hat, cutting across a great glowing bulge of old stars that swells above and below it like the crown. The resemblance is uncanny, and it survives even in a modest telescope, where the Sombrero shows as a small, bright oval with a dark line ruled across it — one of the few galaxies whose signature feature you can actually make out by eye.
