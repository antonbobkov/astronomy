...
The main list plays by a strict rule — everything at least 10° above the horizon between 10 pm and midnight — which quietly leaves a few of the sky's real celebrities on the cutting-room floor. Here are five worth knowing anyway. Most don't quite fit tonight's window: two are showpiece nebulae riding low in Sagittarius, one is the closest stellar nursery to the Sun (and really a camera's target), and the last is an entire distant city of galaxies best saved for spring. The exception is Barnard's E, a dark rift near Altair that's perfectly placed right now. Think of this as the bonus track — objects that reward a darker horizon, a longer exposure, or simply a return trip in another season.
